...
// 2. The hygienic value of Vitamins and Minerals
// 3. Food Hygiene and foodborne diseases
//
// Each question object:
// { q: "Question text", o: ["opt1", "opt2", ...], c: [indicesOfCorrect], t: "s"|"m" }
...
const quizDataBank = {
  1: [
    ...
    {q: "All are essential fatty acids except", o: ["Oleicacid", "Linoleic acid", "linolenic acid", "Arachidonic acid"], c: [0], t: "s"},
    ...
    {q: "Recommended protein intake per day for Indian adult is", o: ["l g/kg", "1.5 g/kg", "1.8 g/kg", "2.3 g/kg"], c: [0], t: "s"},
    {q: "Recommended protein intake per day for infant 0-3 months is", o: ["l g/kg", "1.5 g/kg", "1.8 g/kg", "2.3 g/kg"], c: [3], t: "s"},
    ...
    {q: "The additional calorie requirement during 6-12 months of lactatin is", o: ["300 Kcal", "400 Kcal", "500 Kcal", "550 Kcal"], c: [1], t: "s"},
    ...
    {q: "All the feature of Kwashiokar except", o: ["Skin changes", "Mental alertness", "Edema", "Flag sign"], c: [1], t: "s"},
    ...
    {q: "The mid day meal should supply at least____of total energy requirement", o: ["One fourth", "One third", "Half", "Two third"], c: [1], t: "s"},
    ...
    {q: "All are true regarding essential fatty acid except", o: ["Can be derived only from food", "Unoleic acid is the most important EFA", "Not all polyunsaturated fatty acids are EFA", "Vegetable oil are a poor source of linoleic acid"], c: [3], t: "s"},
    {q: "Food content the following elements:", o: ["Protein", "Fats", "Carbohydrate", "Minerals", "Water", "Organic acids"], c: [0,1,2,3,4], t: "m"},
    {q: "Point out the test (gustatory) elements:", o: ["Carbohydrate", "Organic acids", "Ethier", "Dye", "Tanned elements", "Aromatic element"], c: [1,2,3], t: "m"},
    {q: "Point out the alien (foreigner) elements in food:", o: ["Trace concentration of fertilizes", "Radioactive elements", "Heavy metals salts", "Trace of vegetable origin", "Nitrozamine"], c: [1,2,4], t: "m"},
    {q: "The main goals of hygiene of nutrition are:", o: ["Studying the quality and quantity of food in deferent's activities and live conditions.", "Cultivation the measures to increase the value of the food.", "Cultivation the methods to control the quality of foods.", "Providing the measures against incidence of food poisoning."], c: [0,1,2,3], t: "m"},
    {q: "Nutrition must be:", o: ["Healthy.", "Rational.", "Prophylactic.", "Individual.", "Medical."], c: [0,1,2,3], t: "m"},
    ...
    {q: "Which of the following metals its concentration controlled by international food trade:", o: ["Antimony.", "Iodine.", "Floride.", "Chromium.", "Lithium."], c: [3,4], t: "m"},
    ...
    {q: "The essential amino acids are:", o: ["Treptophane", "Lysine", "Tyrosine"], c: [0,1], t: "m"},
    ...
    {q: "The biological role of proteins", o: ["To take part in hormones synthesis", "To take part in enzyme synthesis", "To take part in antibody"], c: [0,1,2], t: "m"},
    ...
    {q: "WHO define the following as a diseases of civilisation:", o: ["Vitamin C shortage (hypovitamin)", "Vitamin Bl shortage", "Excess of carbohydrate in food."], c: [0,2], t: "m"},
    ...
    {q: "The % of protein in cow's milk is:", o: ["1.4 gm", "More thane 4%", "About 3.4%."], c: [2], t: "s"},
    {q: "100 gm. Of milk gavis:", o: ["90 Кcal.", "67 Кcal.", "30 Кcal."], c: [1], t: "s"},
  ...
  2: [
    ...
    {q: "The most potent form of Vitamin A is", o: ["Carotene", "Vitamin A l", "Vitamin A 2", "Beta Carotene"], c: [1], t: "s"},
    ...
    {q: "Daily requirement of Vitamin D is", o: ["100 IV", "200 IV", "300 IV", "400 IV"], c: [0], t: "s"},
    {q: "Daily requirement of vitamin D durign pregnancy and lactation is", o: ["100 IV", "200 IV", "300 IV", "400 IV."], c: [3], t: "s"},
    ...
    {q: "The safe limit of fluoride content in water is", o: ["0.1 - 0.5 mg/lit", "0.5 - 0.8 mg/lit", "0.8 -1.2 rag/lit", "1-2mg/lit."], c: [1], t: "s"},
    {q: "Vanaspati is fortified with_____IU of vitamin A", o: ["1000", "1500", "2000", "2500."], c: [3], t: "s"},
    ...
    {q: "The vegetable win highest retinol content per 100 gram is", o: ["Carrot", "Spinach", "Green leaves", "Papaya."], c: [0], t: "s"},
    ...
    {q: "All the following cause loss of thiamine except", o: ["Prolonged storage of fruits", "Parboiling of rice", "Toasting of bread", "Cooking of cereals with banking soda."], c: [1], t: "s"},
    {q: "The most common symptom of infanite beri beri", o: ["Peripheral neuritis", "Heart involvement", "Convulsions", "Absence of knee jerk."], c: [0], t: "s"},
    ...
    {q: "Recommended daily requirement of Vitamin B12 during pregnancy and lactation is", o: ["0.2 meg : 1 meg", "1 meg : 1.5 meg", "1.5 meg : 1.5 meg", "1.5 meg : 3 meg."], c: [2], t: "s"},
    ...
    {q: "All the following are called major minerals except", o: ["Sodium", "Pottassium", "Magnesium", "Iron."], c: [3], t: "s"},
    ...
    {q: "Source of calcium are:", o: ["Milk", "Cereals", "Green leafy vegetables."], c: [0,2], t: "m"},
    {q: "Role of Iron in the body:", o: ["Brain function", "Regulation of body temperature", "Synthesis of nucleic acids"], c: [2], t: "s"},
    {q: "The protein content of 100 gm of cereals", o: ["3-5%", "7-12%", "more thane 20%."], c: [1], t: "s"},
    ...
    {q: "Biological role of fermium:", o: ["Support breathing and blood cells formation", "Component of deferent's enzymes."], c: [0,1], t: "m"},
    {q: "Point out the food with high concentration of nitrate:", o: ["Greens", "Root fruits", "Berry", "Melon field fruits."], c: [0,1], t: "m"},
    {q: "Point out the foods which may content high concentration of benzaperine:", o: ["Milk", "Meat", "Mollusc and oyster", "Kidney", "Liver", "Mushrooms."], c: [2,5], t: "m"},
    {q: "The main functions of the vitamins are:", o: ["Building", "A source of energy", "Specific."], c: [0,2], t: "m"},
    {q: "The causes of hypovitamines divided in to:", o: ["Externals", "Internals", "Climetologicals."], c: [0,1,2], t: "m"},
    {q: "Which of the following is a energy vitamin:", o: ["Vitamin C", "Vitamin D", "Vitamin B1."], c: [0], t: "s"},
    {q: "All are fat soluble vitamins except:", o: ["A", "B", "D", "E."], c: [1], t: "s"},
    {q: "Performed vitamin A is:", o: ["Retinol", "Alpha-carotene", "Beta-carotene."], c: [0], t: "s"},
    {q: "Function of vitamin A are:", o: ["Anti- infective", "Anti- allergic", "Support skeletal growth."], c: [0,2], t: "m"},
    {q: "Sources of vitamin A:", o: ["Dark green leafy vegetables", "Mango", "Bread", "Egg."], c: [0,1,3], t: "m"},
    {q: "Clinical sign of vitamin A deficiency:", o: ["Conjunctival xerosis", "Night blindness", "Keratomalacia."], c: [0,1], t: "m"},
    {q: "Daily dosage of vitamin A for adults:", o: ["100 iu", "400 iu", "1000 iu."], c: [2], t: "s"},
    {q: "Functions of vitamin D:", o: ["Absorption of calcium and phosphorus", "Reabsorption of phosphate in kidney", "Bone resumption"], c: [0,2], t: "m"},
    {q: "Sources of vitamin E:", o: ["Vegetable oil", "Egg yolk", "Milk", "Butter."], c: [0,1,3], t: "m"},
    {q: "Biological functions of tokopherol are:", o: ["Stimulate the organs muscles activity", "Improve the muscles ability to work", "Has vitamin activity."], c: [0,1,2], t: "m"},
    ...
    {q: "Biological complex of vitamin C content:", o: ["Ascorbic acid", "Tannic elements", "Vegetables pigments", "Organic vegetables acid", "Silver ion."], c: [0,3], t: "m"},
    {q: "Sources of vitamin C:", o: ["Orange", "Wild rose", "Lime", "Cabbage."], c: [0,1,3], t: "m"},
  ...
  3: [
    ...
    {q: "Following food poisonings are due to performed exotoxin except", o: ["Staphylococcal", "Botulism", "Clostridial", "Bacillus cereus."], c: [2], t: "s"},
    ...
    {q: "All the following are caused by ingestion of contaminated meat except", o: ["Cysticercosis", "Actinouycosis", "Helminthiasis", "Trichenella infection."], c: [2], t: "s"},
    {q: "The freshment milk is measured by:", o: ["Reductase test", "Acidity", "Specific gravity."], c: [0,2], t: "m"},
    {q: "The % of nonbacterial food poisoning incidences in rela­tion to all incidences of food poisoning is:", o: ["1%", "2%", "5%."], c: [0], t: "s"},
    {q: "Which of the following diseases can be caused by ingestion of contaminated meat:", o: ["Anthrax", "Trichinella spiralis", "Helmenthisis."], c: [0,1], t: "m"},
    {q: "Which of the following infection can be transmitted by fish:", o: ["Cholera", "Clostridium botulinum", "Typhoid fever."], c: [0,2], t: "m"},
    {q: "Food borne infections are:", o: ["E. Coli diarrhea", "Typhoid fever", "Leptospirosis."], c: [0,2], t: "m"},
    ...
    {q: "Which of following symptoms toward to early (first) symptoms of botulism:", o: ["Ptosis, Strabismus (cross-eye) and widening of eyes pupil", "Difficulty of swelling", "Speech disruption", "General weakness", "Headache and dizziness."], c: [4], t: "s"},
    {q: "Types of foods which may cause staphylococcal food poi­soning are:", o: ["Egg", "Dairy products", "Cake and pastry with cream."], c: [1,2], t: "m"},
    {q: "Which of the following diseases are mikotoxicosis:", o: ["Ergotism", "Botulism", "Afalatoxicosis", "Sallminlsos", "Ochratoxicosis."], c: [0,2,4], t: "m"},
    {q: "Clinical picture of Ergotism is:", o: ["Acute", "Sub acute", "Chronic."], c: [0,1,2], t: "m"},
    {q: "Point out the foods as source's of afalotoxine:", o: ["Meat", "Fish", "Milk, cheese, and crude", "Grapes, peach and apples"], c: [0,1,2], t: "m"},
    {q: "Preventive measures agenst mikotoxicosis", o: ["Preserving food with proper temperature", "Health education", "Vaccination", "Regular food inspection."], c: [1,3], t: "m"},
    {q: "Acute toxic food poisoning caused by:", o: ["Ingestion food polluted by toxins of specific.", "Ingestion food which content high number of living microbes."], c: [0], t: "s"},
    {q: "Most incidence of botulism in Russia related to following types:", o: ["C,D,E", "A,B,E", "E,F,G."], c: [1], t: "s"},
    {q: "Staphylococ food poisoning characterized by:", o: ["Short incubation period (2-4 hours)", "Symptoms of gastroenteritis", "High temperature.", "Difficult incidence with vomiting and intoxication."], c: [0,1,3], t: "m"},
    {q: "All of the following are source of proteins:", o: ["Egg", "Milk", "Fish", "Soybean."], c: [0,1,2,3], t: "m"},
...
const answers = {}; // answers[topicId][qIndex] = [selectedIndices]
